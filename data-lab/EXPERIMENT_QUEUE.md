...
|---|---|---|---|
| Cycle 6 / DL-007 | Can one bounded final repair make the contribution measurement contract genuinely pilot-ready? | Fix only audited Stage 5 runtime/parity/retry/test-evidence defects; local/isolated tests and sanitized read-only bundle; treatment stays off | Selected; awaiting main-thread evidence |
...
| Active | Cycle 6 / DL-007 | Correcting the audited final defects makes the existing contribution system trustworthy enough for a separately authorized behavioral pilot. | Exact main-thread handoff; zero DB/runtime mismatches; complete adversarial matrix; retry rotation; treatment disabled | Highest immediate decision value because it can unlock real Customer-behavior evidence; fail closes DL-007 without another repair | Awaiting main-thread evidence |
