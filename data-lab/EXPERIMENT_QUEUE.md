...
|---|---|---|---|
| DL-007 | Can SeeFood's own targeted Management and Customer prompts close the comparison gap cheaply enough to scale nationally? | Stage 3: harden attempt binding and terminal review, separate behavioral and gold targets, then blind-audit at most 100 deterministic candidate dishes with bounded evidence; no treatment or DataLab production access | Stage 2 Revise; Push 3 required |
...
| 1 | DL-007 | Targeted Management and Customer contribution prompts close the final comparison gap more cheaply than another automatic source. | Stage 3 must enforce attempt-target binding, complete the review audit chain, define honest behavioral versus gold target classes, and blind-audit at most 100 deterministic rights-only candidates before a live treatment; no DataLab outreach, production access, or paid calls | Tests the Customer-supply frontier before adding more Management-only pipes | Stage 2 Revise: 5,048 mechanical dishes, 4,876 rights-only failures, 0 qualified targets, 0 attempts |
