...
|---|---|---|---|
| DL-007 | Can SeeFood's own targeted Management and Customer prompts close the comparison gap cheaply enough to scale nationally? | Read-only first-party funnel audit and paper experiment; no messages, production change, account creation, or paid quota | Next bounded cycle |
