...
|---|---|---|---|
| DL-007 | Can SeeFood's own targeted Management and Customer prompts close the comparison gap cheaply enough to scale nationally? | Stage 2: corrected read-only event frame, qualified dish-level target roster, bounded evidence, and privacy-safe instrumentation validation; no DataLab production access or paid calls | Stage 1 Revise; Push 2 required |
...
| 1 | DL-007 | Targeted Management and Customer contribution prompts close the final comparison gap more cheaply than another automatic source. | Stage 2 must exclude fixture/ineligible traffic, qualify targets at dish level, and validate full prompt-to-verification instrumentation before a bounded real-user test; no DataLab outreach, account creation, production access, or paid calls | Tests the Customer-supply frontier before adding more Management-only pipes | Stage 1 Revise: 0 creditable contributions; 89 mechanical entity targets; conversion unmeasurable |
